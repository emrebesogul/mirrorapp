...
class DropZone extends React.Component {
    ...
    reportMeasurements() {
      ...
      this.wrapper.measure((_, __, width, height, x, y) => {
        if (!this.props.dragging) this.context.dragContext.updateZone({width, height, x, y, ref: this.wrapper, onEnter: this.onEnter, onLeave: this.onLeave, onDrop: this.onDrop});
      })
    }
    ...
    render() {
        return <View style={this.props.style} pointerEvents={this.props.pointerEvents} onLayout={this.reportMeasurements} ref={c => this.wrapper = c}>
          {
